...
const MyProfile = () => {
  ...
  return (
    <>
        <h1 className="mb-4 text-3xl font-medium text-richblack-5">My Profile</h1>

        <div className='text-white flex flex-col items-center justify-around '>
        

            {/* section 1 */}
            <div className='w-full flex items-center justify-between rounded-md border-[1px]
            ...
            border-richblack-700 bg-richblack-800 p-8 px-12 w-full">
            ...
            border-richblack-700 bg-richblack-800 p-8 px-12 w-full">
                <div className='w-full flex flex-row justify-between items-center'>
                    <p className='font-semibold text-lg text-richblack-5'>Personal Details</p>
