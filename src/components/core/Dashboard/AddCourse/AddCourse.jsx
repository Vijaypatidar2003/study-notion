...
const AddCourse = () => {
  return (
    <>
        <div className='text-richblack-5 flex w-full items-start gap-x-6'>
            ...
            <div className="sticky top-10 hidden max-w-[400px] flex-1 rounded-md 
            border-[1px] border-richblack-700 bg-richblack-800 p-6 xl:block">
