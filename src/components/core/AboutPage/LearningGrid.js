...
const LearningGrid = () => {
  return (
    <div className='mx-auto grid grid-cols-1 lg:grid-cols-4 mb-10 w-11/12 max-w-maxContent p-5'>
        {
            LearningGridArray.map((card,index)=>{
                return (
                    <div key={index}
                        ...
                        ${card.order===3 && "lg:col-start-2 lg:h-[300px] p-5"}
                        ${card.order<0 && "bg-transparent"}`}
                    >
                        {
                            card.order<0  ?
                            (<div className='lg:w-[90%] flex flex-col pb-5 gap-3 p-5'>
